    ...
    <div className="residencies">
      ...
      <div className="scrollimage">
        <div className="scroll">
          <img src={scroll[key - 3].image} alt="flat1" />
          <p style={{ fontSize: "1.2rem" }}>{scroll[key - 3].price}</p>
          <h2>{scroll[key - 3].heading}</h2>
          <p>{scroll[key - 3].content}</p>
        </div>

        <div className="scroll A1">
          <img src={scroll[key - 2].image} alt="flat1" />
          <p style={{ fontSize: "1.2rem" }}>{scroll[key - 2].price}</p>
        ...
        <div className="scroll A1">
          ...
          <p style={{ fontSize: "1.2rem" }}>{scroll[key - 1].price}</p>
        ...
        <div className="scroll A1">
          ...
          <p style={{ fontSize: "1.2rem" }}>{scroll[key].price}</p>
